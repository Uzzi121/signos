function zodiac(){
    ...
    if((dia>=24 && mes==8)||(dia<=24 && mes==9)){
        document.getElementById('Imagenes').src="./Virgo.png"
    }
    if((dia>=24 && mes==9)||(dia<=23 && mes==10)){
        document.getElementById('Imagenes').src="./Libra"
    }
    if((dia>=24 && mes==10)||(dia<=22 && mes==11)){
        document.getElementById('Imagenes').src="./Scorpio"
    }
    ...
    if((dia>=19 && mes==2)||(dia<=20 && mes==3)){
        document.getElementById('Imagenes').src="./pisis.png"
    }
